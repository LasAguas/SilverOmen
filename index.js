function render() {
            ...
            '<form id="mc-embedded-subscribe-form" novalidate>' +
              '<div id="mc_embed_signup_scroll">' +
                ...
                '<div class="mc-consent">' +
                  '<input type="checkbox" id="mc-consent-home" />' +
  ...
  // Init header behaviors (loader, scroll)
  Header.init();

  // Wire the newsletter form to the Las Aguas dashboard mailing list
  SilverOmenMailingSignup({
    form: 'mc-embedded-subscribe-form',
    slug: 'newsletter-sign-up-htuw',
    formId: 'd7a4d029-6735-418c-878c-861f4cc53c06',
    msg: 'mc-signup-msg',
    consent: 'mc-consent-home',
  });
}
