(function () {
  ...
  if (getConsent() === null) {
    ...
    banner.style.cssText = [
      ...
      'right:0',
      'z-index:99999',
      'background:rgba(20,30,12,0.97)',
      'border-top:1px solid rgba(157,86,218,0.4)',
      'padding:1rem 1.5rem',
      'display:flex',
      'align-items:center',
    ...
    banner.innerHTML = [
      ...
      ' <a href="/privacy" style="color:#9d56da;text-decoration:underline">Privacy policy</a></span>',
      ...
      '    padding:0.45rem 1rem;border:1px solid #9d56da;',
      '    background:#9d56da;color:#f8f8f8;cursor:pointer;',
      '    font-family:Brans,sans-serif;font-size:0.7rem;letter-spacing:0.1em;',
